        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl text-gray-300 max-w-3xl mx-auto mb-4">
              Master Every Social Channel
            </p>
            <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-8">
              Strategic presence across all major platforms to maximize your brand's reach and engagement
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="/" className="px-8 py-3 border-2 border-gray-500 text-gray-200 font-semibold rounded-lg hover:bg-gray-800/50 backdrop-blur-sm transition-all duration-300">
                Back to Home
              </a>
            </div>
          </div>
